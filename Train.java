 ...
 * Each car holds a set number of passengers, and the train is powered by an
 * engine.
 */
public class Train {
    ...
    /**
     * Constructs a Train object with the specified engine fuel type, fuel
     * capacity, number of cars, and passenger capacity per car.
     *
    ...
    /**
     * Returns the total passenger capacity of the train by summing the capacity
     * of all cars.
     *
    ...
    /**
     * Prints a manifest of all passengers in each car of the train. Each car is
     * numbered in the output, followed by a list of its passengers.
     */
